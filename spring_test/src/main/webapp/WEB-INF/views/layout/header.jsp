...
<script
	...
	<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@100..900&family=Roboto:wght@400;500;700&display=swap" rel="stylesheet">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<sec:authorize access="isAuthenticated()">
						...
						<li class="nav-item"></li><a class="nav-link" href="/member/detail">내정보보기</a>
						<li class="nav-item"><a class="nav-link" href="/member/logout">로그아웃</a></li>
						<a href="/member/logout"><button type="button" hidden id="trigger"></button></a>
					</sec:authorize>
